...
namespace EventGenerator.Tests
{
    ...
    public class EventGeneratorTests
    {
        ...
        public void DoesEventExistTrueTest()
        {
            ...
            _eventRepo.Setup(x => x.GetEventsFor(selectedDate)).Returns(events);
        ...
        {
            // Arrange
            _eventRepo.Setup(x => x.GetEventsFor(It.IsAny<DateTime>())).Returns(new List<Event>());
            var start = DateTime.Today;
        ...
        public void GenerateEventsForActivitiesAndDateRange_SingleDayAndEventExists_Test()
        {
            ...
            var existingEvents = new List<Event> {
                new Event {
                    ActivityName = frisbee.Name
                }
            };

            _eventRepo.Setup(x => x.GetEventsFor(It.IsAny<DateTime>())).Returns(existingEvents);
        ...
        public void CreateEventsFor_Test()
        {
            ...
            _activtyRepo.Setup(x => x.GetActive()).Returns(activities);
