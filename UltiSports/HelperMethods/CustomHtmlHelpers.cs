...
namespace UltiSports.HelperMethods
{
    public static class CustomHtmlHelpers
    {
        ...
        /// <param name ="elementStatus">This element status controlls whether or not the element is grayed out for a _user. This is a default parameter set to Enabled, so if no value is passed an element will be enabled. It expects "Disabled" as a value, other values may produce unexpected behavior.</param>
